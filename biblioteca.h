...
#define GET_CLIENT_BY_FILE_COMMAND 7
#define GET_CLIENT_BY_ID_COMMAND 8
#define ADD_FILE_CLIENT_COMMAND 9
#define DELETE_CLIENT_COMMAND 10
#define SEND_FILE_COMMAND 11

#define STATUS_OK 101
#define STATUS_NOT_FOUND 404

#define FILE_BLOCK_SIZE 5000
